...
const HomeBody3 = () => {
  ...
  return (
    <div className="m-auto w-full h-52 mt-7">
      <form className="flex m-auto py-2 px-5 flex-col items-center w-fit justify-center rounded-2xl border-4">
        ...
        <input type="password" name="password" id="password" required autoComplete='off' placeholder="Password" className="w-52 text-black outline-none h-8 rounded-lg px-2 py-1 mb-2" />
