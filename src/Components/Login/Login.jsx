...
const Login = () => {
  return (
    <div className="w-screen h-fit flex items-center justify-center py-32">
      <div>
        <form className="flex bg-gray-400 shadow-xl shadow-gray-600 p-10 flex-col items-center w-fit justify-center rounded-2xl" onLoad={"reset"}>
